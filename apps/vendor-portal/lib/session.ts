 ...
 * and a vendor session cannot be the same browser session, so a
 * vendor cannot arrive at the staff application already authenticated,
...
export const CREDENTIAL_COOKIE = 'cog_vendor_credential';
