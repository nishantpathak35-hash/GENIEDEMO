 ...
 * and a client session cannot be the same browser session, so a
 * client cannot arrive at the staff application already authenticated,
...
export const CREDENTIAL_COOKIE = 'cog_client_credential';
